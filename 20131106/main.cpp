...
class CTime{
      ...
      bool operator>(CTime &aTime); //overloaded function
...
bool CTime::operator>(CTime &aTime) 
{
     return this->duration() > aTime.duration();
}
...
int main(int argc, char *argv[])
{
    ...
    cout << "TIME1's duration: " <<endl   //輸出time1, time2的秒數
         ...
         << time1.duration() <<endl;
    if(time0>time1)
        cout << "TIME1 is later." <<endl;
    else
        cout << "TIME2 is later." <<endl;
